...
<div class="form-page">
    ...
    <div class="page-header mb-4">
        ...
        <div>
            <h2 class="mb-1 fw-bold">Edit Kelas</h2>
            <p class="text-muted mb-0 small">Ubah informasi kelas</p>
        </div>
    </div>
            ...
            <div class="form-card-body">
                ...
                <div class="mb-0">
                    ...
                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                              rows="4" placeholder="Keterangan tambahan tentang kelas...">{{ old('description', $class->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
