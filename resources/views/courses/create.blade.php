...
<div class="form-page">
    ...
    <div class="page-header mb-4">
        ...
        <div>
            <h2 class="mb-1 fw-bold">Tambah Mapel Baru</h2>
            <p class="text-muted mb-0 small">Buat mata pelajaran baru</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('courses.store') }}">
        ...
        <div class="form-card mb-4">
            <div class="form-card-body">
                ...
                <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                          rows="5" placeholder="Jelaskan tentang mata pelajaran ini...">{{ old('description') }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('courses.index') }}" class="btn btn-outline-secondary btn-lg rounded-pill flex-fill">
