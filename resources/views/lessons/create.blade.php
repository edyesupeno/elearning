...
<div class="form-page">
    ...
    <div class="page-header mb-4">
        ...
        <div>
            <h2 class="mb-1 fw-bold">Tambah Materi</h2>
    ...
    <form method="POST" action="{{ route('lessons.store', $course) }}" enctype="multipart/form-data">
        ...
        <div class="form-card mb-3">
            <div class="form-card-body">
                ...
                <textarea name="content" class="form-control @error('content') is-invalid @enderror" 
                          rows="6" placeholder="Jelaskan materi pembelajaran...">{{ old('content') }}</textarea>
                @error('content')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="form-card mb-4">
            <div class="form-card-body">
                ...
                <small class="text-muted">Opsional - Upload file materi pembelajaran (bisa lebih dari 1 file)</small>
            </div>
        </div>
