...
<div class="form-page">
    ...
    <div class="page-header mb-4">
        ...
        <div>
            <h2 class="mb-1 fw-bold">Edit Materi</h2>
            <p class="text-muted mb-0 small">{{ $course->title }}</p>
        </div>
    </div>

    <form method="POST" action="{{ route('lessons.update', [$course, $lesson]) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-card mb-3">
            <div class="form-card-body">
                ...
                <input type="text" name="title" class="form-control form-control-lg @error('title') is-invalid @enderror" 
                       ...
                       placeholder="Contoh: Pengenalan Materi" required>
                @error('title')
        ...
        <div class="form-card mb-3">
            <div class="form-card-body">
                ...
                <textarea name="content" class="form-control @error('content') is-invalid @enderror" 
                          rows="6" placeholder="Jelaskan materi pembelajaran...">{{ old('content', $lesson->content) }}</textarea>
                @error('content')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="form-card mb-4">
            <div class="form-card-body">
                ...
                <small class="text-muted">Opsional - Upload file materi pembelajaran tambahan</small>
            </div>
        </div>

        <div class="form-actions">
            <button type="submit" class="btn btn-primary btn-lg rounded-pill flex-fill" id="submitBtn">
